...
* At the minute we overwrite the training checkpoints and output, might be better in future if we make a time dir and put them in there instead so nothing gets overwritten